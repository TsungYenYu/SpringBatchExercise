...
//            		tokenizer
    ...
    @Bean
    public DataItemReadListener dataItemReadListener() {
...
//    @Bean
//    public DataItemValidProcessor dataValidProcessor() {
//    	return new DataItemValidProcessor();
//    }
    //step1 end
